    ...
    try {
      ...
      if (formdata.type === "Login") {
        if (currentLogin === "Admin") {
          resp = await makeUnauthenticatedPOSTRequest(
          ...
          resp = await makeUnauthenticatedPOSTRequest(
            endpoints.EMPLOYEE_CODE_LOGIN_API,
            { employeeCode: formdata.email, password: formdata.password }
          );
          ...
          <form onSubmit={submitHandler}>
            ...
            <div className="authTogle">
              <div
                ...
                className={`${
                  formdata?.type === "Login" && "currentBar"
                } normalbar`}
              >
                Login
              </div>
              <div
                ...
                className={`${
                  formdata?.type === "Signup" && "currentBar"
                } normalbar`}
              >
                Signup
              </div>
            ...
            <label>
              {formdata?.type === "Login" ? (
                <div className="currentLogin">
                  <p
                    onClick={() => setCurrentLogin("Admin")}
                    className={`${currentLogin === "Admin" && "crlin"}`}
                  >
                    Admin Email
                  </p>{" "}
                  <span>/</span>
                  <p
                    onClick={() => setCurrentLogin("Code")}
                    className={`${currentLogin === "Code" && "crlin"}`}
                  >
                    Employee Code
                  </p>
                </div>
